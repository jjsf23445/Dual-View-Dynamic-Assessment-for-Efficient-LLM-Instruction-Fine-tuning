...
parser.add_argument("--train_file", type=str, required=True,
                    help="The path to the training data file we'd like to obtain the gradients/representations for.")
parser.add_argument(
    "--info_type", choices=["grads", "reps", "loss"], required=True, help="The type of information")
...
# Load dataset from train_file
dataset = get_training_dataset(args.train_file, tokenizer, args.max_length)
